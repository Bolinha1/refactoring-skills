...
class Conta
{
    public function __construct(
        ...
        private float $taxaJuros, // usada por lógica relacionada ao tipo
    ) {}

    public function jurosParaValor(float $valor): float
    {
        return $this->taxaJuros * $valor;
    }
}
...
class TipoConta
{
    public function __construct(private float $taxaJuros) {}
...
class Conta
{
    public function __construct(private TipoConta $tipo) {}

    public function jurosParaValor(float $valor): float
    {
        return $this->tipo->getTaxaJuros() * $valor; // delega para TipoConta
    }
}
```
...
class Conta
{
    private float $taxaJuros; // antigo — deve ser deletado
    private TipoConta $tipo;
}
```
