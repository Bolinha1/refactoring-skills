---
name: refactoring-php
description: >
  Use when reviewing or refactoring PHP code. Detects 23 code smells and guides
  step-by-step refactoring with before/after examples. Based on refactoring.guru.
---

# Refactoring PHP

## When to use
When the user asks to review, improve, clean up, or refactor PHP code.
