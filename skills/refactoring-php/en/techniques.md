...
You have a `switch`/`match` or `if/elseif/else` chain that performs different behaviours depending on the object type or a property that simulates a type.
