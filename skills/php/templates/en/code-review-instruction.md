...
- [ ] Are there properties only used by some methods, not all?
...
- [ ] Are there associative arrays with magic string keys to structure data?
...
- [ ] Is there a `switch`/`match` or `if/elseif` chain that dispatches by type?
