...
- [ ] A subclass overrides a parent method only to throw `\BadMethodCallException` or similar
...
class Bird {
    ...
    public function fly(): void { /* flap wings */ }
    public function land(): void { /* touchdown */ }
}

// Penguin IS-A Bird on paper, but cannot fly
class Penguin extends Bird {
    public function fly(): void {
        throw new \BadMethodCallException('Penguins cannot fly');
    }
}
...
class Sparrow extends Bird implements Flyable {
    public function getName(): string { return 'Sparrow'; }
    public function fly(): void { /* flap */ }
    public function land(): void { /* touchdown */ }
}

class Penguin extends Bird {
    public function getName(): string { return 'Penguin'; }
    public function swim(): void { /* splash */ }
}
```
...
- Code that calls `fly()` must type-hint `Flyable`, not just any `Bird`
...
public function fly(): void { /* do nothing */ }
```
