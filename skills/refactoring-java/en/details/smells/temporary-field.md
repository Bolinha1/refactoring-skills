...
public class RouteCalculator {
    private String[] stops;     // only set during calculation
    private int totalDistance;  // only valid after calculate()
    private String fastestPath; // null unless calculate() ran
    ...
    public void calculate() {
        ...
        this.totalDistance = computeDistance(this.stops);
        this.fastestPath = findFastestPath(this.stops);
    }
...
public class RouteResult {
    ...
    private final String fastestPath;

    public RouteResult(int totalDistance, String fastestPath) {
        this.totalDistance = totalDistance;
        this.fastestPath = fastestPath;
    }

    public int getTotalDistance() { return totalDistance; }
    public String getFastestPath() { return fastestPath; }
}

public class RouteCalculator {
    public RouteResult calculate(String[] stops) {
        int distance = computeDistance(stops);
        String path = findFastestPath(stops);
...
public String getFastestPath() {
    if (!isCalculated) throw new IllegalStateException("Call calculate() first");
...
class CalculatingRouteCalculator extends RouteCalculator {
    private String fastestPath; // same problem, just renamed
}
```
